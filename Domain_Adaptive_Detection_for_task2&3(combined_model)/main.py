...
def single_domain_training(model, device):
    model.build_discriminators(device)
    # Record the start time
    start_time = time.time()
    # Build dataloaders
    # train_loader = build_dataloader_double_domain(args, args.source_dataset, 'source', args.target_dataset, 'target', 'train', train_trans)
    source_loader = build_dataloader(args, args.source_dataset, 'source', 'train', train_trans)
    target_loader = build_dataloader(args, args.target_dataset, 'target', 'train', train_trans)
